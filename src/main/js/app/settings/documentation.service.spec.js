...
describe('documentation.service.spec.js', function() {
  ...
  describe('onDocumentationUpdate emit spec', function() {
    ...
    function documentationRemove() { documentationService.documentation.remove(docId); }
    function documentationUpdate() { documentationService.documentation.save(docId, {}); }
    function documentationSave() { documentationService.documentation.save(withoutId, {name: 'name'}); }
    function versionRemove() { documentationService.version.remove(docId, versionId); }
    function versionFileUpload() { documentationService.version.uploadFile(docId, versionId, 'file content'); }
    function versionUpdate() { documentationService.version.save(docId, {id: versionId, name: 'update'}); }
